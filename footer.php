...
<footer class="footer py-5">
    <div class="container-xl">
        ...
        <div class="colophon d-flex justify-content-between align-items-center flex-wrap">
            <div>
                Arcus Investment Limited is authorised and regulated in the UK by the <a href="https://www.fca.org.uk/" target="_blank">Financial Conduct Authority</a>.<br>
                &copy; <?= esc_html( gmdate( 'Y' ) ); ?> All rights reserved. 
            </div>
            <div>
